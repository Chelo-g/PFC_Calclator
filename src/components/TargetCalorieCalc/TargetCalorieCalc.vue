  ...
  <div>
    ...
    <div>
      <table class="calTable">
        <tr>
          <th>現在の体重(kg)</th>
          <th><input v-model.number="BodyWeight" type="number" @change="doTargetUpdata"></th>
        </tr>
        <tr>
          <th>蛋白質(kcal)</th>
          <th><input v-model.number="ProteinCal" type="number" name="ProtainCalBox" @change="doProteinUpdata"></th>
        </tr>
        <tr>
          <th>脂質(kcal)</th>
          <th><input v-model.number="FatCal" name="FatCalBox" type="number"  @change="doFatUpdata"></th>
        </tr>
        <tr>
          <th>炭水化物(kcal)</th>
          <th><input v-model.number="CarbonateCal" type="number" name="CarbonateCalBox" @change="doCarbonateUpdata"></th>
        </tr>
        </table>
    </div>
    <div>
