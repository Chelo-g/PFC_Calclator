...
export default {
  ...
  computed: {
    ...
    parcentProtein() {
      return (
        (this.$store.getters.ProteinCalorie / this.$store.getters.TargetCalorie) *
        100
      ).toFixed(1);
    },
    parcentFat() {
      return ((this.$store.getters.FatCalorie / this.$store.getters.TargetCalorie) * 100).toFixed(
        1
      );
    },
    parcentCarbo() {
      return (
        (this.$store.getters.CarbonateCalorie / this.$store.getters.TargetCalorie) *
        100
      ).toFixed(1);
    },
  },
