...
export default {
    ...
    methods: {
        ...
        addFoods(){
            var item ={weight: 100,Protein: parseFloat(this.addProtein),Fat:parseFloat(this.addFat),Carbo:parseFloat(this.addCarbo),name: this.addName,lists: {list: this.$store.getters.FoodListNumber}}
