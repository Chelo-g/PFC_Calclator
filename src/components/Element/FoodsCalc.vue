    ...
    <div>
      <div>
        ...
        >
          ...
          <el-table-column prop="Protein" label="蛋白質(kcal)"> </el-table-column>
          <el-table-column prop="Fat" label="脂質(kcal)"> </el-table-column>
          <el-table-column prop="Carbo" label="炭水化物(kcal)"> </el-table-column>
          <el-table-column prop="Sum" label="合計(kcal)"> </el-table-column>
        </el-table>
      </div>
      ...
      <div class="foodlist__table">
        ...
        >
          ...
          <el-table-column prop="Protein" sortable label="蛋白質(g)" width="110"> </el-table-column>
          <el-table-column prop="Fat" sortable label="脂質(g)" width="110"> </el-table-column>
          <el-table-column prop="Carbo" sortable label="炭水化物(g)" width="110"> </el-table-column>
          <el-table-column label="(g)" sortable width="160">
  ...
  computed: {
    ...
    calTable() {
      ...
      this.$set(
        item3,
        'Fat',
        (this.$store.getters.FatCalorie - this.$store.getters.getsumParam('Fat') * 9).toFixed(1)
      );
      this.$set(
        item3,
        'Carbo',
